...
vim.opt.sidescrolloff = 20 -- keep 10 lines to left/right of cursor
...
vim.opt.list = true -- Aktiviert die Anzeige unsichtbarer Zeichen
vim.opt.listchars = {
	tab = "  ", -- Zeigt Tabs als Pfeil an
	trail = "·", -- Markiert Leerzeichen am Ende einer Zeile
	nbsp = "␣", -- Zeigt geschützte Leerzeichen
}
